...
class MjButton extends _Tag {
	...
	function render(){
		...
		$innerAttrs = $this->htmlAttributes([
			'href' => $tag === 'a' ? $this->getAttribute('href') : null,
