...
class TcMjText extends TcBase {
	...
	function test_render(){
		$mj_text = new Yarri\Mjml\Tags\MjText(["content" => "Hello World!"]);
		$this->assertHtmlEquals('<div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">Hello World!</div>',$mj_text->renderContent());
		$this->assertHtmlEquals('<div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">Hello World!</div>',$mj_text->render());

		$mj_text = new Yarri\Mjml\Tags\MjText(["content" => "Hello Universe!","attributes" => ["font-weight" => "bold"]]);
		$this->assertHtmlEquals('<div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:bold;line-height:1;text-align:left;color:#000000;">Hello Universe!</div>',$mj_text->renderContent());
		$this->assertHtmlEquals('<div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:bold;line-height:1;text-align:left;color:#000000;">Hello Universe!</div>',$mj_text->render());

		// render with height
		$mj_text = new Yarri\Mjml\Tags\MjText(["content" => "Nice day!", "attributes" => ["height" => "50"]]);
		$this->assertHtmlEquals('<div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;height:50;">Nice day!</div>',$mj_text->renderContent());
